...
class FLProgSTM32CanBus : public FLProgAbstractCanBus
{

public:
  FLProgSTM32CanBus(CAN_TypeDef *canPort, CAN_PINS pins, RXQUEUE_TABLE rxSize = RX_SIZE_16, TXQUEUE_TABLE txSize = TX_SIZE_16);
  ...
  virtual bool hasNewReadMessage() { return _hasNewMessage; };
  virtual CAN_message_t *getReadMessage() { return &_readMessage; };
...
private:
  ...
  void setBaudRateValues(CAN_HandleTypeDef *CanHandle, uint16_t prescaler, uint8_t timeseg1, uint8_t timeseg2, uint8_t sjw);
